        ...
        return (
            <View style={styles.questionNumbersContainer}>
                {questionsData.map((question, index) => {
                    ...
                    const isAttempted = answeredQuestions[index] !== null;
                    const isFlagged = bookmarkedQuestions[index];
                    const isNotVisited = answeredQuestions[index] === null && !isFlagged;
                    ...
                    if (isAttempted) {
                        ...
                        questionButtonStyle.push(styles.visitedQuestion);
                    } else if (isNotVisited) {
                        questionButtonStyle.push(styles.notVisitedQuestion);
                    }
