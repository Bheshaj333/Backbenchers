...
import MockTestSolutionsPageSidePanel from "./MockTestSolutionsPageSidePanel";
...
const MockTestSolutionsPage = ({ route }) => {
        ...
        return (
            <View style={styles.optionsContainer}>
                {questionsData[currentQuestionIndex].options.map((option, index) => {
                    let optionButtonStyle = [styles.optionButton];
                    ...
                    const incorrectOptionSelected = option !== correctAnswer && option === answered;
                    if(correctOption){
                        optionButtonStyle.push(styles.correctOption)
                    } else if (incorrectOptionSelected) {
                        optionButtonStyle.push(styles.incorrectOption);
                    }

                    return (
                        <View key={index} style={optionButtonStyle}>
                            <AutoHeightWebView
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {isSidePanelOpen && (
                <MockTestSolutionsPageSidePanel
                    ...
                    return (
                        <View key={index} style={optionButtonStyle}>
                            ...
                            {incorrectOptionSelected && (
                                <MaterialIcons name="close" size={24} color="red" style={styles.icon} />
                            )}
                        </View>
                    );
                })}
...
const styles = StyleSheet.create({
    ...
    mathJaxOptionContainer: {
        maxWidth: '90%', // Adjusted to leave space for the icon
        paddingVertical: 1,
    },
    footerContainer: {
        flexDirection: 'row',
